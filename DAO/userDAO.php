<?php
	...
	function editarUserDAO($nome, $usuario, $senha, $confirmar_senha, $email, $tipo_user, $id_curso){
		$conn = conectar();

		try {
			$editarUser = "UPDATE Usuarios set nome = '$nome', usuario = '$usuario', senha = '$senha', confirmar_senha = '$confirmar_senha', email = '$email', tipo_user = '$tipo_user', id_curso = '$id_curso' ";
