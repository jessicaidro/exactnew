...
?>
				<div class="row">
					...
					<div class="input-field col s6">
						<input type="password" name="txtConfirmar" id="txtConfirmar" max-length="50" placeholder="Confirme a senha"/>
                    ...
                    <button name="acao" value="EditarProfessor" class="btn waves-effect waves-light blue darken-4" type="submit"><i class="material-icons right">send</i>EDITAR</button>
					</div>
						</form>
				</div>
