...
?>
				...
				<div class="row">
						...
						<h3>Cadastro <b>Trabalho</b></h3>
							<form action="../Forms/formtrabalho.php" id="formTrabalho" method="POST" enctype="multipart/form-data" class="col s12">
								<div class="input-field col s12">
									<input type="text" name="txtTitulo" id="txtTitulo" max-length="60" placeholder="Insira o nome do Trabalho"/>
					...
					Seu trabalho é?
                        <p>
                            <label>
                            <input name="txtTipoArquivo" class="blue darken-4" type="radio" value="0" checked />
                            <span>TCC</span>
                            </label>
                        </p>
                        <p>
					...
					<div class="input-field col s12"> 
						<br>
						<br>
						<button name="acao" value="CadastrarTrabalhoProfessor" class="btn waves-effect waves-light blue darken-4 " type="submit"><i class="material-icons right">send</i>CADASTRAR</button>
								</div>
							</form>
					</div>
				</div>
